       ...
       if(status==="on"){
            switch(spinner){
                case 1 :
                    ...
                    break;
                case 2 :
                    $("body").append('<div style="display:flex;align-items:center;justify-content:center;position:fixed;z-index:9998;background:rgba(255,255,255,0.5);width:100%;height:100vh;top:0px;right:0px;" id="spinner-wrapper"><div class=" display-table center animated zoomIn" style="-webkit-animation-duration: 450ms;animation-duration: 450ms;" id="spinner"><div class="spinner2"><div class="double-bounce1"></div><div class="double-bounce2"></div></div></div></div>');
                    break;
                case 3 :
                    $("body").append('<div style="display:flex;align-items:center;justify-content:center;position:fixed;z-index:9998;background:rgba(255,255,255,0.5);width:100%;height:100vh;top:0px;right:0px;" id="spinner-wrapper"><div class=" display-table center animated zoomIn" style="-webkit-animation-duration: 450ms;animation-duration: 450ms;" id="spinner"><div class="spinner3"><div class="cube1"></div><div class="cube2"></div></div></div></div>');
                    break;
                case 4 :
                    $("body").append('<div style="display:flex;align-items:center;justify-content:center;position:fixed;z-index:9998;background:rgba(255,255,255,0.5);width:100%;height:100vh;top:0px;right:0px;" id="spinner-wrapper"><div class=" display-table center animated zoomIn" style="-webkit-animation-duration: 450ms;animation-duration: 450ms;" id="spinner"><div class="spinner4"></div></div></div>');
                    break;
                case 5 :
                    ...
                    break;
                case 6 :
                    $("body").append('<div style="display:flex;align-items:center;justify-content:center;position:fixed;z-index:9998;background:rgba(255,255,255,0.5);width:100%;height:100vh;top:0px;right:0px;" id="spinner-wrapper"><div class=" display-table center ranimated zoomIn" style="-webkit-animation-duration: 450ms;animation-duration: 450ms;" id="spinner"><div class="spinner6"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div></div>');
                    break;
                case 7 :
                ...
                case 10 :
                    ...
                    break;
                default :
                    $("body").append('<div style="display:flex;align-items:center;justify-content:center;position:fixed;z-index:9998;background:rgba(255,255,255,0.5);width:100%;height:100vh;top:0px;right:0px;" id="spinner-wrapper"><div class="display-table center animated zoomIn" style="-webkit-animation-duration: 450ms;animation-duration: 450ms;" id="spinner"><div class="spinner11"><div class="rect1"></div><div class="rect2"></div><div class="rect3"></div><div class="rect4"></div><div class="rect5"></div></div></div></div>');
            }
            if( typeof txt != typeof undefined ){
                $('#spinner-wrapper').append('<div class="text-center mt16 font10">'+txt+'</div>');
            }
            $('#spinner').show();
